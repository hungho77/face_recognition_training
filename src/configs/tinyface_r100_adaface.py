...
config.loss = "Adaface"
config.output = "./trained_models/adaface_tinyface_r100_v1"
config.network = "iresneta100"
config.resume = False
config.pretrained_backbone_model = "./weights/adaface_ir101_webface12m.pt"
