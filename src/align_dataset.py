...
def parse_arguments(argv):
    ...
    parser.add_argument('--input_dir', default="./train_tmp/faces_emore", type=str, help='Directory with unaligned images.')
    parser.add_argument('--output_dir', default="./train_tmp/face_aligned", type=str, help='Directory with aligned face thumbnails.')
